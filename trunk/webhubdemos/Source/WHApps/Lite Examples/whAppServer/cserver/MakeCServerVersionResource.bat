...
echo    VALUE "FileDescription", "WebHub Application Server\000" >> "%~dp0%resfilenamenoext%.rc"
...
echo    VALUE "Description", "a description\000" >> "%~dp0%resfilenamenoext%.rc"
echo    VALUE "DisplayName", "WebHub %servicename%\000" >> "%~dp0%resfilenamenoext%.rc"
echo    VALUE "ProductName", "WebHub Lite Server\000" >> "%~dp0%resfilenamenoext%.rc"
echo    VALUE "OriginalFilename", "cserver.exe\000" >> "%~dp0%resfilenamenoext%.rc"
echo    VALUE "Technical Support", "https://www.href.com/contact\000" >> "%~dp0%resfilenamenoext%.rc"
echo    VALUE "LegalCopyright", "Copyright \251 2002 - 2015 HREF Tools Corp.\000" >> "%~dp0%resfilenamenoext%.rc"
