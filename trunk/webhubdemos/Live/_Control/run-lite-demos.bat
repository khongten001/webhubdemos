...
if "%demodemos%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 20
...
if "%demoadv%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 15
...
if "%demoshowcase%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 25
...
if "%demohtaj%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 15
...
if "%demohtfd%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 15
...
if "%demoform%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 15
...
if "%demofast%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 10
...
if "%demobw%"=="yes"  d:\Apps\HREFTools\miscutil\wait.exe 14
...
if "%demohtsc%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 14
...
if "%demojoke%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 14
