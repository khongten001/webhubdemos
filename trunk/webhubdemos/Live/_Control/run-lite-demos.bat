...
if "%demodemos%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demoadv%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demoshowcase%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 15
...
if "%demohtaj%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demohtfd%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demoform%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demofast%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demobw%"=="yes"  d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demohtsc%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
...
if "%demojoke%"=="yes" d:\Apps\HREFTools\miscutil\wait.exe 9
