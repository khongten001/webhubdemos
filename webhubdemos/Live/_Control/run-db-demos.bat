...
if %demodsp%==yes d:\Apps\HREFTools\miscutil\wait.exe 30
...
REM d:\Apps\HREFTools\miscutil\wait.exe 30
...
if %demojpeg%==yes d:\Apps\HREFTools\miscutil\wait.exe 30
...
if %demohtcl%==yes d:\Apps\HREFTools\miscutil\wait.exe 24
...
if %demohtfs%==yes d:\Apps\HREFTools\miscutil\wait.exe 24
...
if %demofire%==yes d:\Apps\HREFTools\miscutil\wait.exe 30
...
if %demohtfm%==yes d:\Apps\HREFTools\miscutil\wait.exe 24
...
if %demodbhtml%==yes d:\Apps\HREFTools\miscutil\wait.exe 24
...
::08Jan2011 OFF d:\Apps\HREFTools\miscutil\wait.exe 24
