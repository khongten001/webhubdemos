...
namespace SeleniumTests
{
    public class SeleniumTests
	{
        ...
        bool compare_result(string title)
        {
            ...
            reg = new Regex("192.168.1.71", RegexOptions.IgnoreCase);
            //s1 = reg.Replace(s1, "demos.href.com");
            s2 = reg.Replace(s2, "demos.href.com");
        ...
        {
			Console.WriteLine("---Test star Open home page......");	
			selenium_command(SeleniumAction.Open, "/showcase::1204");	
			Console.WriteLine("---Star:1.Easier HTML......");	
			selenium_command(SeleniumAction.Click, "link=Easier HTML");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			...
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.8......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.1......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Down']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.2......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.3......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.4......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.5......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.6......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.7......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.9.8......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Back:1.4.9......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---1.4.10 ......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Back:1.Easier HTML......");	
			selenium_command(SeleniumAction.Click, "link=Easier HTML");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			...
			selenium_command(SeleniumAction.GoBack);	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Bak:Homepage......");	
			selenium_command(SeleniumAction.Click, "link=SHOWCASE");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Star:2.Forms with Built-in Save-State......");	
			...
			selenium_command(SeleniumAction.GoBack);	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Back:2.2......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Back:Homepage......");	
			selenium_command(SeleniumAction.Click, "link=SHOWCASE");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Star:3.WebMaster Topics......");	
			...
			Console.WriteLine("---3.4.1 Error:time out......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Down']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Back:3.4......");	
			selenium_command(SeleniumAction.Click, "link=StyleSheets");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			...
			selenium_command(SeleniumAction.Click, "link=SHOWCASE");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Star:4.E-Mail......");	
			...
			selenium_command(SeleniumAction.Click, "link=SHOWCASE");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Star:5.Surfer Tracking......");	
			...
			Console.WriteLine("---Star:6.Java, JavaScript and XML......");	
			...
			selenium_command(SeleniumAction.Click, "link=SHOWCASE");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---Star:7.Unleash your imagination......");	
			...
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---7.1.8......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---7.1.9......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
			Console.WriteLine("---7.1.10......");	
			selenium_command(SeleniumAction.Click, "//img[@alt='Next']");	
			selenium_command(SeleniumAction.WaitForPageToLoad, "90000");
