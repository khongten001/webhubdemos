unit uDefaultSelenium_1_0_3;

interface

uses
  uISelenium_1_0_3, uICommandProcessor_1_0_3, uHttpCommandProcessor_1_0_3,
  uCommon;
...
procedure DefaultSelenium.SetExtensionJs(extensionJs: UTF8String);
begin		
...
procedure DefaultSelenium.Start(optionsString: UTF8String);
begin
...
procedure DefaultSelenium.MouseDownRight(locator: UTF8String);
begin
	commandProcessor.DoCommand('mouseDownRight', ArrayOfUTF8String.Create(locator));
end;
...
procedure DefaultSelenium.MouseDownRightAt(locator: UTF8String; coordString: UTF8String);
begin
	commandProcessor.DoCommand('mouseDownRightAt', ArrayOfUTF8String.Create(locator, coordString));
end;
...
procedure DefaultSelenium.MouseUpRight(locator: UTF8String);
begin
	commandProcessor.DoCommand('mouseUpRight', ArrayOfUTF8String.Create(locator));
end;
...
procedure DefaultSelenium.MouseUpRightAt(locator: UTF8String; coordString: UTF8String);
begin
	commandProcessor.DoCommand('mouseUpRightAt', ArrayOfUTF8String.Create(locator, coordString));
end;
...
procedure DefaultSelenium.SelectPopUp(windowID: UTF8String);
begin
	commandProcessor.DoCommand('selectPopUp', ArrayOfUTF8String.Create(windowID));
end;

procedure DefaultSelenium.DeselectPopUp();
begin
	commandProcessor.DoCommand('deselectPopUp', ArrayOfUTF8String.Create());
end;
...
procedure DefaultSelenium.CaptureEntirePageScreenshot(filename: UTF8String; kwargs: UTF8String);
begin
  commandProcessor.DoCommand('captureEntirePageScreenshot', ArrayOfUTF8String.Create(filename, kwargs));
end;

procedure DefaultSelenium.Rollup(rollupName: UTF8String; kwargs: UTF8String);
begin
  commandProcessor.DoCommand('rollup', ArrayOfUTF8String.Create(rollupName,kwargs));
end;

procedure DefaultSelenium.AddScript(scriptContent: UTF8String; scriptTagId: UTF8String);
begin
  commandProcessor.DoCommand('addScript', ArrayOfUTF8String.Create(scriptContent,scriptTagId));
end;

procedure DefaultSelenium.RemoveScript(scriptTagId: UTF8String);
begin
  commandProcessor.DoCommand('removeScript', ArrayOfUTF8String.Create(scriptTagId));
end;

procedure DefaultSelenium.UseXpathLibrary(libraryName: UTF8String);
begin
  commandProcessor.DoCommand('useXpathLibrary', ArrayOfUTF8String.Create(libraryName));
end;
...
function DefaultSelenium.CaptureScreenshotToString(): UTF8String;
begin
	result := commandProcessor.GetString('captureScreenshotToString', ArrayOfUTF8String.Create());
end;

function DefaultSelenium.CaptureEntirePageScreenshotToString(kwargs: UTF8String): UTF8String;
begin
	result := commandProcessor.GetString('captureEntirePageScreenshotToString', ArrayOfUTF8String.Create(kwargs));
end;
...
function DefaultSelenium.RetrieveLastRemoteControlLogs(): UTF8String;
begin
	result := commandProcessor.GetString('retrieveLastRemoteControlLogs', ArrayOfUTF8String.Create());
end;
...
procedure DefaultSelenium.AddCustomRequestHeader(key: UTF8String; value: UTF8String);
begin
  commandProcessor.DoCommand('addCustomRequestHeader', ArrayOfUTF8String.Create(key, value));
end;

function DefaultSelenium.CaptureNetworkTraffic(_type: UTF8String): UTF8String;
begin
  result := commandProcessor.GetString('captureNetworkTraffic', ArrayOfUTF8String.Create(_type));
end;
