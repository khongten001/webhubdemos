...
type
   TPMForDSP = class(TDMForWHDemo)
      procedure ProjMgrDataModulesCreate3(Sender: TtpProject; var ErrorText: String; var Continue: Boolean);
      procedure ProjMgrGUICreate(Sender: TtpProject; const ShouldEnableGUI: Boolean; var ErrorText: String; var Continue: Boolean);
      procedure ProjMgrDataModulesCreate2(Sender: TtpProject; const SuggestedAppID: String; var ErrorText: String; var Continue: Boolean);
      procedure ProjMgrDataModulesInit(Sender: TtpProject; var ErrorText: String; var Continue: Boolean);
      procedure ProjMgrStop(Sender: TtpProject; var ErrorText: String; var Continue: Boolean);
   private
...
begin
   ...
   With pWebApp, DSPAppHandler do
      begin
         ...
         OnBadBrowser := DSPAppBadBrowser;               // 1-June-2001 AML
         OnBadIP := DSPAppBadIP;                         // 1-June-2001 AML
      end;
   pWebApp.Refresh;            // Sets WordsDatabaseName
end;

procedure TPMForDSP.ProjMgrDataModulesCreate3(Sender: TtpProject; var ErrorText: String; var Continue: Boolean);
begin
   Inherited;
   {M}Application.CreateForm(TDSPdm, DSPdm);
   {M}Application.CreateForm(TdmDisplayResults, dmDisplayResults);
   {M}Application.CreateForm(TdmDSPWebSearch, dmDSPWebSearch);   // web action component to display results.
end;

procedure TPMForDSP.ProjMgrDataModulesInit(Sender: TtpProject; var ErrorText: String; var Continue: Boolean);
begin
   Inherited;
   DSPdm.Init;                 // Loads database, using AppSettings. Rubicon components in here. BEFORE MacrosUpdate!!
